...
export default function HoverFooter() {
  ...
  return (
    <footer className="bg-[#0F0F11] relative h-fit rounded-3xl overflow-hidden m-8 dark:bg-black/40">
      <div className="max-w-7xl mx-auto p-14 z-40 relative">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-8 lg:gap-16 pb-12">
          ...
          <div className="flex flex-col space-y-4">
            ...
            <p className="text-sm leading-relaxed text-gray-300">
              QuickCover is an AI-powered Insurance platform for underwriting speed.
            </p>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-sm space-y-4 md:space-y-0 text-gray-300">
          ...
          <p className="text-center md:text-left">
            &copy; {new Date().getFullYear()} QuickCover. All rights reserved.
          </p>
        </div>
      </div>

      {/* Text hover effect */}
      <div className="lg:flex hidden h-[30rem] -mt-52 -mb-36 relative z-10 w-full items-center justify-center pointer-events-none">
        <div className="w-[80vw] h-[100%] mx-auto pointer-events-auto">
           <TextHoverEffect text="QuickCover" className="z-50 w-full h-full" />
        </div>
      </div>
